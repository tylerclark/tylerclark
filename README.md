...
#### Skills:
- Web: Nextjs, JS/TS, Node, Vue, React, Nuxt, Python
- Salesforce: LWC, Apex, Aura, Visualforce, SQL/SOQL
- Platforms: Supabase, Firebase, Google Cloud, AWS, OpenAI
